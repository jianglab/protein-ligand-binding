...
def main():
    ...
    with st.sidebar:
        ...
        st.write(r'Thus we can numerically solve for $L_{free}$, recursively plugging that value back into our fraction bound equation, generating a binding fraction curve.')
